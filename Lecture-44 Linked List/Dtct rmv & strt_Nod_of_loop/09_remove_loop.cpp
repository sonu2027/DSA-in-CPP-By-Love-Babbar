// Removing loop with the help of floyd cycle detection
#include <iostream>
#include <map>
using namespace std;
...
// Detection of Loop's first element or Node with the help of floyd cycle detection algorithm
...
void remove_loop(Node *&head)
{
    ...
    Node *startingOfLoop=get_starting_Node(head);
...
int main()
{
    ...
    // Node *starting_Node = get_starting_Node(head);

    // if (starting_Node != NULL)
    //     cout << "Data of starting Node is:" << starting_Node->data << endl;
    // else
    //     cout << "Loop is not present:" << endl;
